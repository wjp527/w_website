...
export const Hexagon = (props: ComponentPropsWithoutRef<'svg'>) => {
  ...
  return (
    ...
    <svg width="82" height="72" viewBox="0 0 82 72" fill="none" stroke="currentColor" stroke-width="6" xmlns="http://www.w3.org/2000/svg" className={twMerge('text-fuchsia-500/10 -rotate-6', className)}>
      <path
